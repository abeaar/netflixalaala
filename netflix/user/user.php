      ...
      <div class="navbar">
        ...
        <nav class="">
          <ul class="navbar-nav">
            ...
            <li> <a href="#" class="navbar-link">watchlist</a> </li>
        ...
        <div class="navbar-actions">
          ...
          <a href="logout.php" class="navbar-signin" onClick="return confirm('Logout ??')">
      ...
      <section class="banner">
        <div class="banner-card">
          ...
          <div class="card-content">
            ...
            <h2 class="card-title">Money heist: Pencurian Dana - SYL</h2>
          </div>
